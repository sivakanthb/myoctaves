...
export const SONG_CATALOGUE: DiscoverySong[] = [
  ...
  { id: 's_tel_05', title: 'Adi Raa Adi Raa', film: 'Swathi Muthyam', artist: 'S.P. Balasubrahmanyam', composer: 'Ilaiyaraaja', year: 1986, language: 'Telugu', genre: 'Tollywood', mood: 'Happy', weather: ['Sunny'], personId: 'spb', reelFriendly: false },
  ...
  { id: 's_tel_09', title: 'Ninne Pelladutha', film: 'Missamma', artist: 'P. Susheela & Ghantasala', composer: 'S. Rajeswara Rao', year: 1955, language: 'Telugu', genre: 'Tollywood', mood: 'Happy', weather: ['Sunny'], personId: 'susheela', reelFriendly: false },
  { id: 's_tel_10', title: 'Sirimalle Puvva', film: 'Padaharella Vayasu', artist: 'S.P. Balasubrahmanyam & S.P. Sailaja', composer: 'Ilaiyaraaja', year: 1978, language: 'Telugu', genre: 'Tollywood', mood: 'Happy', weather: ['Sunny'], personId: 'spb', reelFriendly: true },
  { id: 's_tel_11', title: 'Aa Ante Amalapuram', film: 'Arya', artist: 'Karthik', composer: 'Devi Sri Prasad', year: 2004, language: 'Telugu', genre: 'Tollywood', mood: 'Energetic', weather: ['Sunny'], reelFriendly: true },
  ...
  { id: 's_hin_03', title: 'Mere Sapno Ki Rani', film: 'Aradhana', artist: 'Kishore Kumar', composer: 'S.D. Burman', year: 1969, language: 'Hindi', genre: 'Bollywood', mood: 'Happy', weather: ['Sunny'], personId: 'kishore', reelFriendly: true },
  ...
  { id: 's_hin_15', title: 'Pyar Kiya To Darna Kya', film: 'Mughal-e-Azam', artist: 'Lata Mangeshkar', composer: 'Naushad', year: 1960, language: 'Hindi', genre: 'Bollywood', mood: 'Energetic', weather: ['Any'], personId: 'naushad', reelFriendly: true },
  ...
  { id: 's_hin_17', title: 'Dil Chahta Hai', film: 'Dil Chahta Hai', artist: 'Shankar Mahadevan', composer: 'Shankar-Ehsaan-Loy', year: 2001, language: 'Hindi', genre: 'Bollywood', mood: 'Happy', weather: ['Sunny'], reelFriendly: true },
  { id: 's_hin_18', title: 'Tum Hi Ho', film: 'Aashiqui 2', artist: 'Arijit Singh', composer: 'Mithoon', year: 2013, language: 'Hindi', genre: 'Bollywood', mood: 'Romantic', weather: ['Rainy', 'Winter'], reelFriendly: true },
  { id: 's_hin_19', title: 'Jai Ho', film: 'Slumdog Millionaire', artist: 'A.R. Rahman', composer: 'A.R. Rahman', year: 2008, language: 'Hindi', genre: 'Bollywood', mood: 'Energetic', weather: ['Any'], personId: 'arr', reelFriendly: true },
  ...
  // TAMIL
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  { id: 's_tam_01', title: 'Ilayanila', film: 'Payanangal Mudivathillai', artist: 'K.J. Yesudas', composer: 'Ilaiyaraaja', year: 1982, language: 'Tamil', genre: 'Tollywood', mood: 'Peaceful', weather: ['Winter'], personId: 'yesudas', reelFriendly: true },
  { id: 's_tam_02', title: 'Mannil Indha Kadhal', film: 'Keladi Kanmani', artist: 'K.J. Yesudas', composer: 'Ilaiyaraaja', year: 1990, language: 'Tamil', genre: 'Tollywood', mood: 'Romantic', weather: ['Any'], personId: 'ilayaraja', reelFriendly: true },
  { id: 's_tam_03', title: 'Sundari Neeyum', film: 'Michael Madana Kama Rajan', artist: 'Ilaiyaraaja', composer: 'Ilaiyaraaja', year: 1990, language: 'Tamil', genre: 'Tollywood', mood: 'Happy', weather: ['Sunny'], personId: 'ilayaraja', reelFriendly: true },
  { id: 's_tam_04', title: 'Thee Thee', film: 'Thiruda Thiruda', artist: 'A.R. Rahman', composer: 'A.R. Rahman', year: 1993, language: 'Tamil', genre: 'Tollywood', mood: 'Energetic', weather: ['Sunny'], personId: 'arr', reelFriendly: true },
  { id: 's_tam_05', title: 'Ennodu Nee Irundhal', film: 'I', artist: 'A.R. Rahman', composer: 'A.R. Rahman', year: 2015, language: 'Tamil', genre: 'Tollywood', mood: 'Romantic', weather: ['Any'], personId: 'arr', reelFriendly: true },
  { id: 's_tam_06', title: 'Munbe Vaa', film: 'Sillunu Oru Kaadhal', artist: 'A.R. Rahman', composer: 'A.R. Rahman', year: 2006, language: 'Tamil', genre: 'Tollywood', mood: 'Romantic', weather: ['Winter'], personId: 'arr', reelFriendly: true },
  ...
  // CARNATIC / CLASSICAL
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  { id: 's_car_01', title: 'Kurai Ondrum Illai', film: '', artist: 'M.S. Subbulakshmi', year: 1960, language: 'Tamil', genre: 'Carnatic', mood: 'Devotional', weather: ['Any'], personId: 'mss', reelFriendly: false },
  ...
  { id: 's_car_03', title: 'Endaro Mahanubhavulu', film: '', artist: 'Balamuralikrishna', year: 1970, language: 'Telugu', genre: 'Carnatic', mood: 'Devotional', weather: ['Any'], personId: 'bmk', reelFriendly: false },
  { id: 's_car_04', title: 'Vatapi Ganapatim Bhaje', film: '', artist: 'Balamuralikrishna', year: 1975, language: 'Telugu', genre: 'Carnatic', mood: 'Devotional', weather: ['Any'], personId: 'bmk', reelFriendly: true },
  ...
  // DEVOTIONAL
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  { id: 's_dev_01', title: 'Om Jai Jagdish Hare', film: '', artist: 'Anuradha Paudwal', year: 1988, language: 'Hindi', genre: 'Devotional', mood: 'Devotional', weather: ['Any'], reelFriendly: false },
  { id: 's_dev_02', title: 'Prabhuvuku Sarivaaru', film: 'Aapadbandhavudu', artist: 'Balamuralikrishna', composer: 'M.M. Keeravani', year: 1992, language: 'Telugu', genre: 'Devotional', mood: 'Devotional', weather: ['Any'], personId: 'bmk', reelFriendly: true },

  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  // PATRIOTIC
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  { id: 's_pat_01', title: 'Aye Mere Watan Ke Logon', film: '', artist: 'Lata Mangeshkar', year: 1963, language: 'Hindi', genre: 'Patriotic', mood: 'Patriotic', weather: ['Any'], personId: 'lata', reelFriendly: true },
  { id: 's_pat_02', title: 'Maa Tujhe Salaam', film: 'Vande Mataram', artist: 'A.R. Rahman', year: 1997, language: 'Hindi', genre: 'Patriotic', mood: 'Patriotic', weather: ['Any'], personId: 'arr', reelFriendly: true },
  { id: 's_pat_03', title: 'Sandese Aate Hain', film: 'Border', artist: 'Sonu Nigam & Roop Kumar Rathod', composer: 'Anu Malik', year: 1997, language: 'Hindi', genre: 'Patriotic', mood: 'Patriotic', weather: ['Any'], reelFriendly: true },

  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  // FOLK
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  { id: 's_folk_01', title: 'Choti Si Asha', film: 'Roja', artist: 'Minmini', composer: 'A.R. Rahman', year: 1992, language: 'Hindi', genre: 'Folk', mood: 'Happy', weather: ['Sunny'], personId: 'arr', reelFriendly: true },
  { id: 's_folk_02', title: 'Urvasi Urvasi', film: 'Kadhalan', artist: 'A.R. Rahman', composer: 'A.R. Rahman', year: 1994, language: 'Tamil', genre: 'Folk', mood: 'Energetic', weather: ['Sunny'], personId: 'arr', reelFriendly: true },

  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  // WESTERN-INFLUENCED / INDIE
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  { id: 's_west_01', title: 'Kun Faya Kun', film: 'Rockstar', artist: 'A.R. Rahman & Javed Ali', composer: 'A.R. Rahman', year: 2011, language: 'Hindi', genre: 'Indie', mood: 'Peaceful', weather: ['Winter', 'Rainy'], personId: 'arr', reelFriendly: true },
  { id: 's_west_02', title: 'Khwaja Mere Khwaja', film: 'Jodhaa Akbar', artist: 'A.R. Rahman', composer: 'A.R. Rahman', year: 2008, language: 'Hindi', genre: 'Indie', mood: 'Devotional', weather: ['Any'], personId: 'arr', reelFriendly: true },
  ...
  // KANNADA
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  { id: 's_kan_01', title: 'Kannu Hodiyaka', film: 'Auto Raja', artist: 'S.P. Balasubrahmanyam', composer: 'Rajan-Nagendra', year: 1980, language: 'Kannada', genre: 'Tollywood', mood: 'Happy', weather: ['Sunny'], personId: 'spb', reelFriendly: true },
  { id: 's_kan_02', title: 'Naanu Ninna Mareyalare', film: 'Naa Ninna Mareyalare', artist: 'S.P. Balasubrahmanyam', composer: 'Ilaiyaraaja', year: 1986, language: 'Kannada', genre: 'Tollywood', mood: 'Romantic', weather: ['Any'], personId: 'spb', reelFriendly: true },
